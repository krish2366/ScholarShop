...
function Navbar() {
  return (
    <nav className="flex items-center justify-between px-5 py-4 bg-orange-400 text-white w-full shadow-sm">
      ...
      <div className="flex items-center gap-6">
        ...
        {localStorage.getItem("accessToken") ? (
          <Link 
            to="/profile"
            className="bg-[#FFF4DC] size-9 rounded-full flex items-center justify-center">
