...
const Post = () => {
  return (
    <div class='bg-[#DCE6EC] h-screen'>
        <h2 className='font-bold  text-4xl pt-16 ml-[36rem] '>Post Your Item</h2>
        <div className='flex'>
            ...
            <div class="flex-wrap ">
                ...
                <div class="p-2">
                        <button className='bg-[#0057A1] text-white rounded-md py-2 px-4  '>Upload photos</button>
                </div>
        ...
        <div className='flex justify-center'>
            <button className='bg-[#183C6D] text-white rounded-xl w-64 p-2 h-12 font-bold text-xl'>Post</button>
        </div>
    </div>
